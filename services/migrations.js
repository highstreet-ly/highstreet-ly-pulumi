...
const postgresSystemUser = config.require("postgresSystemUser");
const postgresSystemPass = config.require("postgresSystemPass");
						...
						containers: [
							{
								...
								env: [
									{
										name: "DB_USER",
										value: postgresSystemUser
									},
									{
										name: "DB_PASSWORD",
										value: postgresSystemPass
									},
									{
										name: "DB_URL",
